...
namespace PublishRealLiteApi.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "StreamStatDailyAggregates",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StreamStatDailyAggregates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArtistVideos_ArtistProfiles_ArtistProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Releases_ArtistProfiles_ArtistProfileId",
                        column: x => x.ArtistProfileId,
                        principalTable: "ArtistProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StreamStats_ArtistProfiles_ArtistProfileId",
                        column: x => x.ArtistProfileId,
                        principalTable: "ArtistProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_ArtistProfiles_ArtistProfileId",
                        column: x => x.ArtistProfileId,
                        principalTable: "ArtistProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistVideos_ArtistProfileId",
                table: "ArtistVideos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Releases_ArtistProfileId",
                table: "Releases",
                column: "ArtistProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_StreamStatDailyAggregates_ArtistProfileId_Date_Platform",
                table: "StreamStatDailyAggregates",
                columns: new[] { "ArtistProfileId", "Date", "Platform" });

            migrationBuilder.CreateIndex(
                name: "IX_StreamStats_ArtistProfileId_Date_Platform",
                table: "StreamStats",
                columns: new[] { "ArtistProfileId", "Date", "Platform" });

            migrationBuilder.CreateIndex(
                name: "IX_StreamStats_Date_Platform",
                table: "StreamStats",
